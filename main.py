...
def settitlecharinfo(dictfile, value):
    ...
    dictfile["TitleDocument"]["m_TitleObList"]["CCtsTextObject"][
        "CCtsTitleObject"]["TitleCharInfo"]["iAveCharWidth"] = str(value) + ";21;"
    dictfile["TitleDocument"]["m_TitleObList"]["CCtsTextObject"][
        "CCtsTitleObject"]["TitleCharInfo"]["iLineSpace"] = str(value) + ";0;"
    dictfile["TitleDocument"]["m_TitleObList"]["CCtsTextObject"][
        "CCtsTitleObject"]["TitleCharInfo"]["iAveCharHeight"] = str(value) + ";57;"
    dictfile["TitleDocument"]["m_TitleObList"]["CCtsTextObject"][
        "CCtsTitleObject"]["TitleCharInfo"]["iSize"] = str(value) + ";32;"
    return dictfile
